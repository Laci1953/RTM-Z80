...
;
IF	Z80ALL .and. NOSYSSTS
DELAY_30_SEC	equ	12000
DELAY_10_SEC	equ	4000
DELAY_1_SEC	equ	100
DELAY_100_MS	equ	20
DELAY_50_MS	equ	4
ELSE
DELAY_30_SEC	equ	6000
DELAY_10_SEC	equ	2000
DELAY_1_SEC	equ	200
DELAY_100_MS	equ	20
DELAY_50_MS	equ	10
ENDIF
...
_XmRecv:
	PUSH_REGS
	ld	hl,XM_MB
	add	hl,sp		;stack=AF,BC,DE,HL,IX,IY,AF',BC',DE',HL',retaddr,MB_Data
	ld	a,(hl)
	inc	hl
	ld	h,(hl)		
	ld	l,a		;HL=MB_Data
...
csloop:	add	a,(hl)		;Just add up the bytes
	...
	ld	hl,(Timer)
	ld	de,(Sem)
	ld	bc,DELAY_50_MS	;50 ms
	ld	a,(packcnt)
	dec	a
	jr	nz,1f
	ld	bc,DELAY_1_SEC	;1 sec
	ld	a,PACK_GRP
1:
	ld	(packcnt),a
	xor	a		;no repeat
...
__XmSend:
	...
	ld	ix,DELAY_30_SEC	;30 sec timeout
	call	Get1B
...
GotNAK:	
	...
	ld	ix,DELAY_100_MS	;100 ms timeout
	call	Get1B
...
DoneS:
	...
	call	SendBack1B
	ld	ix,DELAY_10_SEC	;10 s timeout
	call	Get1B
;
