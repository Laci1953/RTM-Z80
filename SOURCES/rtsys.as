...
IF	SYSSTS
TotalTicks:defs	2	;total tasks ticks
ENDIF
...
2:
	...
	ld	e,(hl)
	inc	hl
	ld	d,(hl)		;DE=task tics

				;compute task ticks x 100
	ld	hl,0
	push	hl
	ld	hl,100
	push	hl
	ld	hl,0
	call	mul32		;HL DE = 0 DE x 0 100 , 0 100 removed from stack 

	push	de
	exx
	ld	de,(TotalTicks)
	pop	hl
	exx			;HL' = DE, DE' = TotalTicks
	ld	de,0
