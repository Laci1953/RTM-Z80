...
_WriteQ:
	PUSH_REGS
        ld      hl,WQ_Q
        add     hl,sp                   ;stack=AF,BC,DE,HL,IX,IY,AF',BC',DE',HL',retaddr,queue,info
        ld      c,(hl)
	inc	hl
...
_ReadQ:
	PUSH_REGS
        ld      hl,RQ_Q
        add     hl,sp                   ;stack=AF,BC,DE,HL,IX,IY,AF',BC',DE',HL',retaddr,queue
        ld      c,(hl)
	inc	hl
        ld      b,(hl)           	;BC=queue header
	inc	hl
