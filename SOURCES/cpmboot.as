...
copy_0_to_1:
	ld	ix,0		;IX=pointer
	ld	bc,4096		;loop counter
1:
	ld	e,(ix+0)	;load 8 bytes
	ld	d,(ix+1)
	ld	l,(ix+2)
	ld	h,(ix+3)
	exx
...
;	current banks are 0 & 3
;	returns at (IY)
;	at return, current banks are 1 & 3
;
copy_2_to_3:
	ld	a,2		;select bank #2
	out	(BANK_PORT),a
