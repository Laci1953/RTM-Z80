...
ENDC
	...
	call	__GetTicks
	ld	(T_start),de
loop2:				;Cnt x 2 task switches
	ld	hl,(S)
	call	__Wait		;switch to Task1
	ld	hl,(Cnt)
	dec	hl
	ld	(Cnt),hl
	ld	a,l
...
1:	pop	hl
	...
	ret
;
Delta:	defs	2		;count of tics for Cnt x 2 task switches
Timer:	defs	2
TCB1:	defs	2
T_start:defs	2
S:	defs	2
W:	defs	2
X:	defs	2
Cnt:	defw	40000		;how many switches
tx1:	defb	0dh,0ah	
	defm	'Delta='
delta:	defs	4
	defb	'H'
