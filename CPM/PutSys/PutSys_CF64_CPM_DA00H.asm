...
; APPEND THE BDOS+BIOS HEX FILES AFTER THE PUTSYS HEX
;
; THE BDOS+BIOS HEX FILES MUST BE ASSEMBLED AT THE REAL LOCATION,
; BUT THE LOAD ADDRESS MUST BE SHIFTED TO 9XXXH
; EDIT THE BDOS+BIOS HEX FILE, AND CHANGE:
; :20D --> :209
; :20E --> :20A
; :20F --> :20B
; CHANGE ALSO THE LAST RECORDS
